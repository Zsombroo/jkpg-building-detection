...
def class_text_to_int(row_label):
    if row_label == 'black_top_house':
        return 1
    elif row_label == 'white_top_house':
        return 2
    elif row_label == 'red_top_house':
        return 3
    else:
        return None
...
if __name__ == '__main__':
    ...
    input_folder, output_folder, output_filename = input_sanity_check(inputs)
